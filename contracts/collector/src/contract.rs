...
use glow_protocol::collector::{ConfigResponse, HandleMsg, InitMsg, MigrateMsg, QueryMsg};
...
/// asset token => GLOW token and distribute
/// result GLOW token to gov contract
