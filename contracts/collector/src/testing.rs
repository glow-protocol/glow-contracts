...
use glow_protocol::collector::{ConfigResponse, HandleMsg, InitMsg};
...
fn proper_initialization() {
    ...
    let msg = InitMsg {
        ...
        glow_token: HumanAddr("tokenGLOW".to_string()),
...
fn test_sweep() {
    ...
    deps.querier
        .with_terraswap_pairs(&[(&"uusdtokenGLOW".to_string(), &HumanAddr::from("pairGLOW"))]);
    ...
    assert_eq!(
        ...
        vec![
            CosmosMsg::Wasm(WasmMsg::Execute {
                contract_addr: HumanAddr::from("pairGLOW"),
...
fn test_distribute() {
    ...
    assert_eq!(
        ...
        vec![
            CosmosMsg::Wasm(WasmMsg::Execute {
                contract_addr: HumanAddr::from("tokenGLOW"),
