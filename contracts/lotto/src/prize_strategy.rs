...
pub fn execute_lottery(
    ...
    let total_user_lottery_deposits = pool.total_deposits * config.split_factor;
    ...
    if (total_user_lottery_deposits + pool.total_sponsor_amount) >= pooled_lottery_deposits {
