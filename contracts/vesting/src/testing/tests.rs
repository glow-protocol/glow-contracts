...
fn proper_initialization() {
    ...
    let msg = InitMsg {
        ...
        glow_token: HumanAddr::from("glow_token"),
...
fn update_config() {
    ...
    let msg = HandleMsg::UpdateConfig {
        owner: None,
        glow_token: Some(HumanAddr::from("glow_token2")),
    ...
    assert_eq!(
        ...
        ConfigResponse {
            owner: HumanAddr::from("owner2"),
            glow_token: HumanAddr::from("glow_token2"),
            genesis_time: 1u64,
        }
    );
}
...
fn claim() {
    ...
    assert_eq!(
        ...
        vec![CosmosMsg::Wasm(WasmMsg::Execute {
            contract_addr: HumanAddr::from("glow_token"),
